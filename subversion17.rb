...
class Subversion17 < Formula
  ...
  url 'http://archive.apache.org/dist/subversion/subversion-1.7.6.tar.bz2'
  ...
  def patches
    ...
    if with_unicode_path?
      ps << "https://raw.github.com/jiangxin/homebrew-tap/666ff7261a66286b8bbab9572418bbdc9b8dd807/0003-patch-path.c.diff"
    end

#    # Patch to find Java headers
#    if build_java?
#      ps << "https://raw.github.com/jiangxin/homebrew-tap/666ff7261a66286b8bbab9572418bbdc9b8dd807/0002-swig-java.diff"
#     end
